...
fun main(){
    ...
    println("Hasil casting + fallback: $safeString")
    ...
    println("\n=== TEST JAVA INTEROP ===")
    val javaRes = LegacyJavaAPI.fetchServerStatus()
    val statusLen = javaRes!!.length
    println("Status dari Java: $javaRes (Length: $statusLen)")
}